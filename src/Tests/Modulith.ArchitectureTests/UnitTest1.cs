...
using Modulith.Modules.Catalog.Application.Products.CreateProduct;
using Modulith.Modules.Catalog.Domain.Products;
using Modulith.Modules.Catalog.Infrastructure;
using NetArchTest.Rules;

namespace Modulith.ArchitectureTests;
...
public class ArchitectureRulesTests
{
    ...
    {
        var result = Types.InAssembly(typeof(Modulith.BuildingBlocks.Domain.Entity).Assembly)
            .ShouldNot()
    ...
    public void Application_Should_Not_Depend_On_Infrastructure()
    {
        var result = Types.InAssembly(typeof(ICommand).Assembly)
            .ShouldNot()
            .HaveDependencyOn("Modulith.BuildingBlocks.Infrastructure")
            .GetResult();
    ...
    public void Module_Application_Should_Not_Depend_On_Module_Infrastructure()
    {
        var result = Types.InAssembly(CatalogApplication)
            .ShouldNot()
            .HaveDependencyOnAny(
                "Modulith.Modules.Catalog.Infrastructure",
                "Modulith.BuildingBlocks.Infrastructure",
    ...
    public void Module_Domain_Should_Not_Depend_On_Module_Application_Or_Infrastructure()
    {
        var result = Types.InAssembly(CatalogDomain)
            .ShouldNot()
            .HaveDependencyOnAny(
                "Modulith.Modules.Catalog.Application",
                "Modulith.Modules.Catalog.Infrastructure")
            .GetResult();
    ...
    public void IntegrationEvents_Is_The_Only_Catalog_Type_Other_Modules_May_Reference()
    {
        ...
        var result = Types.InAssembly(typeof(Modulith.Modules.Catalog.IntegrationEvents.ProductCreatedIntegrationEvent).Assembly)
            .ShouldNot()
            .HaveDependencyOnAny(
                "Modulith.Modules.Catalog.Domain",
                "Modulith.Modules.Catalog.Application",
                "Modulith.Modules.Catalog.Infrastructure")
            .GetResult();
