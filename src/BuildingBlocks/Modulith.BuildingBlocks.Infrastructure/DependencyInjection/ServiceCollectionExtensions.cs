...
using Modulith.BuildingBlocks.Infrastructure.Events;
using Modulith.BuildingBlocks.Infrastructure.ExecutionContext;
using Modulith.BuildingBlocks.Infrastructure.ModulePersistence;
using Modulith.BuildingBlocks.Infrastructure.Pipeline;
using System.Reflection;

namespace Modulith.BuildingBlocks.Infrastructure.DependencyInjection;
...
{
    public static IServiceCollection AddModulithBuildingBlocks(
